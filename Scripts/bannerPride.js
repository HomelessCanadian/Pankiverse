...
let hue = 0;
const gifUrl = 'https://github.com/HomelessCanadian/Pankiverse/blob/main/trans-flag.gif?raw=true';
let isShowingGif = false;
const gifInterval = 600000; // 10 minutes in milliseconds
...
function checkAndResetGif() {
    ...
    if (isShowingGif) {
        ...
        if (Math.random() > gifChance) {
            ...
            }, gifInterval); // 10 minutes cooldown
        }
...
// GIF check interval (every 10 minutes)
